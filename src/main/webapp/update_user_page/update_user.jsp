...
<head>
    ...
    <link rel="stylesheet" href="update_user_page/css/update_user_style.css" type="text/css">
</head>
<body>	
    <%
    ...
    %>
    <form method="post" action="UpdateUserServlet" class="login">
        <div class="header">
            <h1>Изменение</h1>	   
	</div>   
	<div class="input"> 
            ...
            <input type="password" name="repeat_pass" value="" placeholder="повтор пароля">
        </div> 
        <div class="buttons">
